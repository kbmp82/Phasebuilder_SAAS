		...
		if($this->session->userdata('ID') != ''){
		   ...
		   //	$billing_cycles_trial = $this->input->post('billing_cycles_trial');
            if($sub_type == "article"){
              ...
              if($this->input->post('article_domain') != "" && $this->input->post('article_type') != "" && $this->input->post('article_creation') != "" ){
           ...
           if($this->input->post('article_creation') == "create_self"){
             if($this->input->post('article_title') != ""){
				...
				'article_title' => $this->input->post('article_title'),//$_POST['article_title'],
				'article_type' => $this->input->post('article_type'),//$_POST['article_type'],
                'article_keyword' => $this->input->post('article_keyword'),//$_POST['article_keyword'],
				'article_domain' => $this->input->post('article_domain'),//$_POST['article_domain'],
				'article_ins' => $this->input->post('article_ins'),//$_POST['article_ins'],
...
if($pay_type=='recurring'){
   ...
   if($status_acct && $status_acct == 1){
	...
	function OrderComplete()
	{
       ...
       $result = $this->ArticleModel->order_article($this->session->userdata('ID'),$article['article_details'][0]['article_domain'],$article['article_details'][0]['article_type'],$article['article_details'][0]['article_title'],$article['article_details'][0]['article_ins'],$article['article_details'][0]['article_keyword'],$article['article_details'][0]['article_credits'],$article['article_details'][0]['price']);
      //var_dump($result);
       if($result){
