  <!-- footer -->
            <footer class="footer">© 2018 PhaseBuilder.com - A Phase Brands International, Inc. Company</footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
...
<script src="<?php echo $this->config->base_url(); ?>main/js/lib/html5-editor/wysihtml5-init.js"></script>
    ...
    <script src="<?php echo $this->config->base_url(); ?>main/js/LoadingOverlay.js"></script>
...
jQuery(".sub_menus a").removeClass("active");
    ...
    <script src="<?php echo $this->config->base_url(); ?>main/js/custom.min.js"></script>
     ...
     <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/datatables.min.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/cdn.datatables.net/buttons/1.2.2/js/dataTables.buttons.min.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/cdn.datatables.net/buttons/1.2.2/js/buttons.flash.min.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/cdnjs.cloudflare.com/ajax/libs/jszip/2.5.0/jszip.min.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/cdn.rawgit.com/bpampuch/pdfmake/0.1.18/build/pdfmake.min.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/cdn.rawgit.com/bpampuch/pdfmake/0.1.18/build/vfs_fonts.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/cdn.datatables.net/buttons/1.2.2/js/buttons.html5.min.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/cdn.datatables.net/buttons/1.2.2/js/buttons.print.min.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/datatables/datatables-init.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/intro/intro.js"></script>
   <!--   <script src="<?php echo $this->config->base_url(); ?>main/js/enjoyhint.js"></script> -->

<script src="<?php echo $this->config->base_url(); ?>main/js/hopscotch.js"></script>
