	...
	foreach ($domains as $value) { ?> 
                                    <tr>
                                     ...
                                     <td><span><a href="<?php echo base_url() ?>admin/domain/edit_domain/?action=edit&id=<?php echo $value['id']; ?>">edit</a>/</span>
                                            <span><a id="delete" onclick="return confirm('Are you sure you want to delete this subscription?');" href="<?php echo base_url() ?>admin/domain/edit_domain/?action=delete&id=<?php echo $value['id']; ?>">delete</a></span>
										</td>
