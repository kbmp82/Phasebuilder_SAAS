...
<![endif]-->
  ...
  $(document).ready(function(){
   ...
   $('#domains_table').DataTable();
    $('#transaction11').DataTable();
     $('#ticket_table').DataTable();
      $('#subscription11').DataTable();
                                ...
                                <ul>
                                  ...
                                  ?>
                                       <div class="ntf_msg unread_msg" id="<?php echo $ticket_id;  ?>">
                                            <!-- Message -->
                                            <a class="get_url" id="<?php echo $ticket_id ;  ?>" href="<?php echo $this->config->base_url('admin/SupportTickets/ticket_view/?id=')."$ticket_id"  ; ?>#ntfy<?php  echo $ticket_id ; ?>">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="user-img"> <img src="<?php echo $this->config->base_url(); ?>main/images/users/5.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <a href="#">
                                                <div class="user-img"> <img src="<?php echo $this->config->base_url(); ?>main/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="<?php echo $this->config->base_url(); ?>admin/profile"><i class="ti-user"></i> Profile</a></li>
...
.unread_msg {
   ...
   <script>
  var haveMessages = <?php echo ($all_tickets) ? 1 : 0;?>;
   if (haveMessages === 1){
   $.confirm({
      smoothContent: true,
    columnClass: 'col-md-5',
    title: 'You Have Mesages!',
    content: '<center><p style="text-align: justify;">You have messages waiting. You can view your messages by clicking on "Support" or the blinking red icon in the upper right corner.</p><br><br>',
                            theme: 'modern',
                            closeIcon: true,
                            animation: 'scale',
                            type: 'blue',
 ...
 /*
  ...
  //   $(document).on('click','.get_url',function(e){
            ...
            msg_id    =   $(this).attr('id') ;    
              ...
              t_id =  $(this).children("a").attr("id");
                
              
    
             $(this).removeClass('unread_msg') ;   
        
            url    =   $('.ntf_msg a').attr('href') ;
            
             
             $.ajax({
                    url: '<?php echo $this->config->base_url(); ?>admin/SupportTickets/update_ticket',
                    data: {
                        'n_id': msg_id ,
                        't_id' : t_id 
                        },
