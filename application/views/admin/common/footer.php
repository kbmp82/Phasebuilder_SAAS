...
jQuery(".sub_menus a").removeClass("active");
    ...
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/sticky-kit-master/dist/sticky-kit.min.js"></script>
     <script src="<?php echo $this->config->base_url(); ?>main/js/lib/chart-js/Chart.bundle.js"></script>
    <script src="<?php echo $this->config->base_url(); ?>main/js/lib/chart-js/chartjs-init.js"></script>
    <!--Custom JavaScript -->
